-- Ensure DONE month filtering uses completion date and history is always available.
...
CREATE INDEX IF NOT EXISTS idx_tickets_company_status_done_at
  ON public.tickets (company_id, status, done_at DESC);
